  ...
  const formAdcionaTarefa = document.querySelector('.app__form-add-task');
  const textArea = document.querySelector('.app__form-textarea');
  const ulTarefas= document.querySelector('.app__section-task-list');
  const btnCancelar = document.querySelector('.app__form-footer__button--cancel');
  const paragrafoDescricaoTarefa= document.querySelector('.app__section-active-task-description');

  const btRemovercomcluidas = document.querySelector('#btn-remover-concluidas');
  ...
  const limpaFormulario=()=>{
    textArea.value= '';
    formAdcionaTarefa.classList.add('hidden')
  }
  ...
  function criaElmentoTarefa (tarefa){
  ...
  btTarefa.addEventListener('click',()=>{
    formAdcionaTarefa.classList.toggle('hidden')
  })

  formAdcionaTarefa.addEventListener('submit',(evento)=>{
    evento.preventDefault();
    const tarefa= {
        descricao: textArea.value
    }
    tarefas.push(tarefa);
    const elementoTarefa= criaElmentoTarefa(tarefa)
  ...
  btRemovercomcluidas.onclick = () => removerTarefas(true);
